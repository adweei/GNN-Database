...
data_graph = open(data_graph_dir + 'graph_tag.txt')           #神秘tag咒語，請手建
...
#         #------------------------------------------------------------------------------------------------------------------------
        ...
        #     print(model_choose_file_dir + str(tag_model_list[np.where(tag_model_list[:,0] == (number[1]))[0][0]][1]) + '/' +
        #                                 str(tag_model_list[np.where(tag_model_list[:,0] == (number[1]))[0][0]][2]) +
        #                                 '_round_result_edge_weight_Adjustment.pth')
        #     net.load_state_dict(th.load(model_choose_file_dir + str(tag_model_list[np.where(tag_model_list[:,0] == (number[1]))[0][0]][1]) + '/' +
        #                                 str(tag_model_list[np.where(tag_model_list[:,0] == (number[1]))[0][0]][2])+'_round_result_edge_weight_Adjustment.pth'))
        #     tag_test = model_test()
        #     print('tag\'s GCN acc is: {:.6f}'.format(tag_test.test_model(net, cuda_g, features, labels, retweet_distribution_mask)))
