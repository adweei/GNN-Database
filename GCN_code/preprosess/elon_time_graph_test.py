...
data_graph_dir = 'D:/GNN/MyResearch-main/MyResearch-main/ElonMusk/2023-02-20/data_graph/'
data_graph = open(data_graph_dir+'graph_tag.txt')
...
#-------------------------------------------將tag要選擇的model給讀取出來--------------------------------------------------------------------
model_choose_file_dir = 'D:/GNN/MyResearch-main/MyResearch-main/ElonMusk/2023-02-16/base_graph_for_model/'
...
for number in data_graph_list:
    #----------------------------------------將轉推時間分佈讀取出來----------------------------------------------------------------------------------------------------
    retweet_distribution = np.load('D:/GNN/MyResearch-main/MyResearch-main/ElonMusk/2023-02-20/retweet_distribution/'+str(number[0])+'_graph_retweet_distribution.npy')
    for time_point in range(10):
        ...
        #tag 的結果
        if int(number[1]) != 1:
            dataset,label = load_graphs(data_graph_dir+str(number[0])+"/"+str(time_point)+"/"+str(number[0])+".bin")
            Graph = dataset[0]
            ...
            tag_test.model_save(data_graph_dir+str(number[0])+"/"+str(time_point)+"/"+str(number[0])+'_tag_model_result')
            del net
            print('-------------------------------------------------------------分隔線-------------------------------------------------------------------------')
        #------------------------------------------------------------------------------------------------------
        #retweet count的結果
            ...
            net = Net(len(features[0]))
            net.load_state_dict(th.load(model_choose_file_dir+str(retweet_count_model_list[0][1])+'/'+str(retweet_count_model_list[0][2])+'_round_result_edge_weight_Adjustment.pth'))
            ...
            retweet_count_high.model_save(data_graph_dir+str(number[0])+"/"+str(time_point)+"/"+str(number[0])+'_high_retweet_count_model_result')
            del net
            ...
            net = Net(len(features[0]))
            net.load_state_dict(th.load(model_choose_file_dir+str(retweet_count_model_list[1][1])+'/'+str(retweet_count_model_list[1][2])+'_round_result_edge_weight_Adjustment.pth'))
            ...
            retweet_count_middle.model_save(data_graph_dir+str(number[0])+"/"+str(time_point)+"/"+str(number[0])+'_middle_retweet_count_model_result')
            del net
            ...
            net = Net(len(features[0]))
            net.load_state_dict(th.load(model_choose_file_dir+str(retweet_count_model_list[2][1])+'/'+str(retweet_count_model_list[2][2])+'_round_result_edge_weight_Adjustment.pth'))
            ...
            retweet_count_low.model_save(data_graph_dir+str(number[0])+"/"+str(time_point)+"/"+str(number[0])+'_low_retweet_count_model_result')
            del net
        #------------------------------------------------------------------------------------------------------
        #是tag 3的特別處裡
            if int(number[1]) == 3:
                ...
                net = Net(len(features[0]))
                net.load_state_dict(th.load(model_choose_file_dir+str(distribution_model_list[0][1])+'/'+str(distribution_model_list[0][2])+'_round_result_edge_weight_Adjustment.pth'))
                ...
                retweet_longest.model_save(data_graph_dir+str(number[0])+"/"+str(time_point)+"/"+str(number[0])+'_over_72_model_result')
                del net
                ...
                net = Net(len(features[0]))
                net.load_state_dict(th.load(model_choose_file_dir+str(distribution_model_list[1][1])+'/'+str(distribution_model_list[1][2])+'_round_result_edge_weight_Adjustment.pth'))
                ...
                retweet_longer.model_save(data_graph_dir+str(number[0])+"/"+str(time_point)+"/"+str(number[0])+'_between_48_72_model_result')
                del net
                ...
                net = Net(len(features[0]))
                net.load_state_dict(th.load(model_choose_file_dir+str(distribution_model_list[2][1])+'/'+str(distribution_model_list[2][2])+'_round_result_edge_weight_Adjustment.pth'))
                ...
                retweet_middle.model_save(data_graph_dir+str(number[0])+"/"+str(time_point)+"/"+str(number[0])+'_between_24_48_model_result')
                del net
                ...
                net = Net(len(features[0]))
                net.load_state_dict(th.load(model_choose_file_dir+str(distribution_model_list[3][1])+'/'+str(distribution_model_list[3][2])+'_round_result_edge_weight_Adjustment.pth'))
                ...
                retweet_shorter.model_save(data_graph_dir+str(number[0])+"/"+str(time_point)+"/"+str(number[0])+'_between_12_24_model_result')
                del net
                ...
                net = Net(len(features[0]))
                net.load_state_dict(th.load(model_choose_file_dir+str(distribution_model_list[4][1])+'/'+str(distribution_model_list[4][2])+'_round_result_edge_weight_Adjustment.pth'))
                ...
                retweet_shortest.model_save(data_graph_dir+str(number[0])+"/"+str(time_point)+"/"+str(number[0])+'_in_12_model_result')
                del net
        # print('*****************************************************************************************************************************************************************************************')