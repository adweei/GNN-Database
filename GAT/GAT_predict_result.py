...
predict_graph_dir = elon_mask_test_graph_data_dir + 'no_weight_data_graph/'
#2/16~20的預測結果蒐集
    ...
    for every_time_batch in range(10):#10
        for it in os.scandir(every_graph + str(every_time_batch)):    #需要蒐集幾個test結果
            if it.is_file():
                ...
                file_name_part = re.split('/|\\\\|_', file_name)[1:]
                # print(file_name_part[:])
                if (file_name_part[-1] == 'result.json' ):
                    # print(file_name_part[:])
                    # 篩選固定特徵的結果
...
# print('tag: ', all_tag_result_arrange)

with pd.ExcelWriter(elon_mask_test_graph_data_dir + 'GAT_prediction_result0726/tags_result_rewrite(test).xlsx') as writer:
...
# with pd.ExcelWriter(elon_mask_test_graph_data_dir + 'GAT_prediction_result0721/high_retweet_count_result_rewrite.xlsx') as writer:
...
# with pd.ExcelWriter(elon_mask_test_graph_data_dir + 'GAT_prediction_result/high2_retweet_count_result_rewrite.xlsx') as writer:
...
# with pd.ExcelWriter(elon_mask_test_graph_data_dir + 'GAT_prediction_result0721/middle_retweet_count_result_rewrite.xlsx') as writer:
...
# with pd.ExcelWriter(elon_mask_test_graph_data_dir + 'GAT_prediction_result0721/low_retweet_count_result_rewrite.xlsx') as writer:
...
# with pd.ExcelWriter(elon_mask_test_graph_data_dir + 'GAT_prediction_result0721/first_retweet_distribution_result_rewrite.xlsx') as writer:
...
# with pd.ExcelWriter(elon_mask_test_graph_data_dir + 'GAT_prediction_result0721/second_retweet_distribution_result_rewrite.xlsx') as writer:
...
# with pd.ExcelWriter(elon_mask_test_graph_data_dir + 'GAT_prediction_result0721/third_retweet_distribution_result_rewrite.xlsx') as writer:
...
# with pd.ExcelWriter(elon_mask_test_graph_data_dir + 'GAT_prediction_result0721/forth_retweet_distribution_result_rewrite.xlsx') as writer:
...
# with pd.ExcelWriter(elon_mask_test_graph_data_dir + 'GAT_prediction_result0721/fifth_retweet_distribution_result_rewrite.xlsx') as writer:
...
# with pd.ExcelWriter(elon_mask_test_graph_data_dir + 'GAT_prediction_result0721/sixth_retweet_distribution_result_rewrite.xlsx') as writer:
...
# with pd.ExcelWriter(elon_mask_test_graph_data_dir + 'GAT_prediction_result/first_fixed_feature_retweet_distribution_result_rewrite.xlsx') as writer:
...
# with pd.ExcelWriter(elon_mask_test_graph_data_dir + 'GAT_prediction_result/second_fixed_feature_retweet_distribution_result_rewrite.xlsx') as writer:
...
# with pd.ExcelWriter(elon_mask_test_graph_data_dir + 'GAT_prediction_result/third_fixed_feature_retweet_distribution_result_rewrite.xlsx') as writer:
...
# with pd.ExcelWriter(elon_mask_test_graph_data_dir + 'GAT_prediction_result/forth_fixed_feature_retweet_distribution_result_rewrite.xlsx') as writer:
...
# with pd.ExcelWriter(elon_mask_test_graph_data_dir + 'GAT_prediction_result/fifth_fixed_feature_retweet_distribution_result_rewrite.xlsx') as writer:
...
# with pd.ExcelWriter(elon_mask_test_graph_data_dir + 'GAT_prediction_result/sixth_fixed_feature_retweet_distribution_result_rewrite.xlsx') as writer:
